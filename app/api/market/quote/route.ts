...
const symbol: LiveMarketSymbol = symbolParam;
    ...
    const existingRow: MarketLatestRow | null =
      Array.isArray(readResult.data) && readResult.data.length > 0 ? readResult.data[0] : null;
    ...
    const changeAbs =
      previousPrice !== null ? Number((liveQuote.price - previousPrice).toFixed(4)) : null;
